                ...
                try
                {
                    if (s.length() > 0)
                    {
                        ...
                        for (int x = 0; x < allDataAr.size(); x++)
                        {
                            ...
                            if (dataObj.getString("sortname").contains(s.toString()) || dataObj.getString("name").toLowerCase().contains(s.toString().toLowerCase())|| dataObj.getString("phonecode").toLowerCase().contains(s.toString().toLowerCase()))
                            {
